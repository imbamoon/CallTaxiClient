...
public class RegisterActivity extends Activity implements View.OnClickListener {
    ...
    public EditText inputRegisterId, inputRegisterPwd, inputRegisterRePwd, inputRegisterPhone;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inputRegisterPhone = (EditText)findViewById(R.id.register_phone);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.finish_register_button:
                ...
                String inputPhone = inputRegisterPhone.getText().toString();
